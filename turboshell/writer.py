...
class Writer:
    ...
    def write(self):
        ...
        print(f"Generated {self.total_added} definitions in {time} ms")
    ...
    def _add_definitions(self):
        self.total_added = len(self.ts.aliases) + len(self.ts.functions)
    ...
    def _add_stubs(self):
        ...
        if len(stubs):
            add("# Stubs:")
            add(" ")
            add("alias ts.stub='echo stub'")
            for stub in stubs:
                add(f"alias {stub}=ts.stub")
    ...
    def _add_info_function(self, info_entries, alias_groups, group_info):
        ...
        echo('')
        echo(f'Alias file:  {self.target}')
        echo(f'Rebuilt on:  {self.now}')
        echo('')
        echo('Commands:')
        echo('')
